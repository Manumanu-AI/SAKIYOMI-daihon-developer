...
class UserIndexService:
    ...
    def create_user_index(self, user_id: str, index_name: str, langsmith_project_name: str) -> Dict[str, Any]:
    ...
    def update_user_index(self, user_id: str, index_name: str, langsmith_project_name: str) -> Dict[str, Any]:
        user_index = UserIndex(
            index_id=user_id,
            user_id=user_id,
            index_name=index_name,
